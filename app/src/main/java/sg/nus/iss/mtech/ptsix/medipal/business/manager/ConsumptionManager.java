...
public class ConsumptionManager {
    ...
    public ConsumptionVO castToConsumptionVo(Consumption consumption) {
        ...
        if (consumption instanceof ConsumptionVO) {
            ...
            consumptionVO.setQuantity(consumption.getQuantity());
            consumptionVO.setMedicineID(consumption.getMedicineID());
            consumptionVO.setConsumedOn(consumption.getConsumedOn());
